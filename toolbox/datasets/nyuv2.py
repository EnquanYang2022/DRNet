...
class NYUv2(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        label_edge = f'all_data/change/label_edge/{image_index}.png'
        ...
        label_edge = Image.open(os.path.join(self.root, label_edge))
        ...
        sample['label_edge'] = torch.from_numpy(np.asarray(sample['label_edge'], dtype=np.int64)).float() / 255
